...
import MonthlyTicket from '../../../Layout/ticket/Weekly/KnockKnock';
...
const MonthlyGame: React.FC = () => {
  ...
  useEffect(() => {
    const fetchSoldTickets = async () => {
      try {
        const monthlyDocRef = doc(db, "Weekly", "Knock Knock");
  ...
  const renderNumbers = () => {
    ...
    return (
      <div className='bg-green-500 h-[620px] w-[340px] rounded-xl flex flex-col items-center justify-center p-2'>
        <h1 className='font-extrabold text-2xl text-white m-10'>Knock Knock</h1>
  ...
  return (
    <>
      <div className='sm:overflow-hidden w-full flex flex-col items-center justify-center mb-10'>
        <Header />
        <div className='mt-20'>
          <LotteryInfo gameName={"Knock Knock"} />
        </div>

    ...
    <>
      <div className='tref w-[400px] absolute left-0 sm:w-1/2  flex flex-col items-center mt-[70px] ' ref={ticketRef}>
        <div className='w-full h-[130px]'
          ...
          <p className="text-[8px] relative top-[108px] text-center left-20">ST{ticketCode}</p>
          <p className="text-[8px] absolute left-[315px] top-6 text-white">ST{ticketCode}</p>
          <p className="text-[10px] text-white mt-[74px] ml-8"><span className="archivo-black-regular">{currentDate}</span> </p>
